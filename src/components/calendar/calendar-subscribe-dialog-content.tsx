...
import type { CalendarSubscribeOpenPayload } from "@/lib/calendar-subscribe-handle";

type CalendarSubscribeDialogContentProps = CalendarSubscribeOpenPayload;

export function CalendarSubscribeDialogContent({
  payload,
  feedName,
  title = "S'abonner au calendrier",
  description = "Choisissez votre application pour ajouter ou synchroniser ce calendrier.",
}: CalendarSubscribeDialogContentProps) {
